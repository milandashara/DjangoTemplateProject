      ...
      return this.each(function () {
        ...
        self.bind('click', function (e) {
          ...
          $(document).find('.popover .confirm-dialog-btn-confirm').one('click', function (e) {
             //$('#progress').show();
             //alert('test');
             //document.getElementById('progress').style.display = "block !important";
             document.getElementById('progress').className = 'show';
             document.getElementById('success_alert').className = 'hide';
             document.getElementById('error_alert').className = 'hide';
