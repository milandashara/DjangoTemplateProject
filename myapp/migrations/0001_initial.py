# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-30 05:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_image', models.ImageField(upload_to=b'', verbose_name=b'Item Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('logo', models.ImageField(upload_to=b'', verbose_name=b'Restaurant Logo')),
                ('name', models.CharField(max_length=100)),
        ...
        migrations.AddField(
            model_name='menu',
            name='menu_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.MenuGroup'),
        ),
    ]
